...
CXX="/group/agabi/software/bin/g++-4.8 -m32" ${CTEST} -S seqan_linux_host_32bit.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_g++-4.8-32.log

#CXX="/group/agabi/software/bin/clang++-3.0 -m32" ${CTEST} -S seqan_linux_host_32bit.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_clang++-3.0-32.log
CXX="/group/agabi/software/bin/clang++-3.1 -m32" ${CTEST} -S seqan_linux_host_32bit.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_clang++-3.1-32.log
CXX="/group/agabi/software/bin/clang++-3.2 -m32" ${CTEST} -S seqan_linux_host_32bit.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_clang++-3.2-32.log
CXX="/group/agabi/software/bin/clang++-3.3 -m32" ${CTEST} -S seqan_linux_host_32bit.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_clang++-3.3-32.log
