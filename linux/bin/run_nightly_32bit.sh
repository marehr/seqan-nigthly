...
CXX="g++-4.4 -m32" ctest -S seqan_linux_host_32bit.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_g++-4.6-32.log
...
CXX="g++-4.7 -m32" ctest -S seqan_linux_host_32bit.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_g++-4.7-32.log
