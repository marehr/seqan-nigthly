...
CXX="/group/agabi/software/bin/g++-4.8" ${CTEST} -S seqan_linux_host.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_g++-4.8-64.log

#CXX="/group/agabi/software/bin/clang++-3.0" ${CTEST} -S seqan_linux_host.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_clang++-3.0-64.log
CXX="/group/agabi/software/bin/clang++-3.1" ${CTEST} -S seqan_linux_host.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_clang++-3.1-64.log
CXX="/group/agabi/software/bin/clang++-3.2" ${CTEST} -S seqan_linux_host.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_clang++-3.2-64.log
CXX="/group/agabi/software/bin/clang++-3.3" ${CTEST} -S seqan_linux_host.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_clang++-3.3-64.log
