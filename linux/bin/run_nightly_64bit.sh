...
#CXX="g++-4.4" ctest -S seqan_linux_host.cmake,Nightly -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_g++-4.4-64.log
...
#CXX="g++-4.4" ctest -S seqan_linux_host.cmake,NightlyCoverage -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_g++-4.4-64-coverage.log
#CXX="g++-4.4" ctest -S seqan_linux_host.cmake,NightlyMemCheck -VV -d 2>&1 | tee ${DIR}/../log/ctest_nightly_g++-4.4-64-memcheck.log
popd
